export default {
  async fetch(request, env, ctx) {
    ...
    return handleRequest(request, routes, dockerHub, MODE, TARGET_UPSTREAM);
  },
};

async function handleRequest(request, routes, dockerHub, MODE, TARGET_UPSTREAM) {
